...
import static classy.instructions.Instruction.Type.CONSTANT_PUSH;
import static classy.instructions.Instruction.Type.DYNAMIC_METHOD;
import static classy.instructions.Instruction.Type.FIELD;
import static classy.instructions.Instruction.Type.INCREMENT;
import static classy.instructions.Instruction.Type.JUMP;
import static classy.instructions.Instruction.Type.LOOKUP_SWITCH;
import static classy.instructions.Instruction.Type.METHOD;
import static classy.instructions.Instruction.Type.MULTIDIMENSIONAL_ARRAY;
import static classy.instructions.Instruction.Type.NULLARY;
import static classy.instructions.Instruction.Type.PUSH;
import static classy.instructions.Instruction.Type.RESERVED;
import static classy.instructions.Instruction.Type.TABLE_SWITCH;
import static classy.instructions.Instruction.Type.TYPE;
import static classy.instructions.Instruction.Type.VARIABLE;
